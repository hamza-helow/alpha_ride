...
class CustomerBottomSheet extends StatefulWidget {
  ...
  CustomerBottomSheet({this.callBack ,
    this.whenDriverComing , this.showPromoCodeWidget ,
    this.onStateTripChanged , this.numberHours ,
    this.currentTrip , this.tripActive = false , this.getDriver ,
    this.findDriver = false , this.idDriver , this.deleteRequest});
      ...
      children: [
        Padding(
          ...
          child:  ListTile(
            ...
            title: Text(widget.currentTrip.nameDriver??""),
            subtitle: Row(

              children: [
                Icon(Icons.star  ,color: DataProvider().baseColor,) , Text("${widget.currentTrip.ratingDriver??"-"}"),
              ],

            ),

            trailing: Text("${widget.currentTrip.arriveTime??"-"}"),
        ...
        Padding(
          ...
          child:  ListTile(
            ...
            leading: Image.asset("Assets/enconomy.png"),
            title: Text("${widget.currentTrip.carType} ${widget.currentTrip.carModel}"),
            ...
            children: [
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child:  MaterialButton(
                    color: widget.currentTrip.stateTrip == StateTrip.active ? Colors.red : Colors.green ,

                    shape: RoundedRectangleBorder(

                        borderRadius: BorderRadius.circular(25.0),
                        side: BorderSide(color: widget.currentTrip.stateTrip == StateTrip.active ? Colors.red : Colors.green)
                    ),
                    ...
                    height: 50.0,
                    child: Text( widget.currentTrip.stateTrip == StateTrip.active ?  "Cancel" : "Trip started", style: TextStyle(color: Colors.white ,fontWeight: FontWeight.bold ,fontSize: 22.0)),
